                                        ...
                                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <strong>
                                                            <?php echo $show->nama_keg; ?></strong> pada tanggal <strong>
                                                            <?php echo $show->tgl_keg; ?></strong> di <strong>
                                                            <?php echo $show->lokasi; ?></strong>. Ortom Pelaksana <strong>
                                                            <?php echo $show->ortom_peny; ?></strong>
                                                    </td>
                                                    <td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Tambah Data Portofolio Mahasiswa<strong>
                        </h3>
                    </div>
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/control/tambah_kegiatan'?>">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <input name="tgl_keg" class="form-control" type="date">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <input name="lokasi" class="form-control" type="text" placeholder="Lokasi Kegiatan...">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <select name="ortom_penye" class="form-control">
        ...
        <div class="modal fade" id="edit_<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/control/edit_kegiatan'?>">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-3">Tanggal Kegiatan</label>
                                <div class="col-xs-8">
                                    <input name="tgl_keg" class="form-control" type="date" value="<?php echo $tgl_keg; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-3">Lokasi</label>
                                <div class="col-xs-8">
                                    <input name="lokasi" class="form-control" type="text" value="<?php echo $lokasi; ?>" placeholder="Lokasi Kegiatan...">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-3">Deskripsi Kegiatan</label>
                                <div class="col-xs-8">
                                    <textarea class="form-control" name="deskripsi" placeholder="Deskripsi Kegiatan..."> <?php echo $deskripsi; ?></textarea>
                                </div>
                            </div>
                        </div>
        ...
        <div id="hapus_<?php echo $id; ?>" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/control/hapus_kegiatan'?>">
