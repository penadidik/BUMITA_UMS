                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div>
                                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        Semester:
                                                        <?php echo $show->semester; ?><br>TA:
                                                        <?php echo $show->TA; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $show->nama_organisasi; ?><br>Sebagai <strong>
                                                            <?php echo $show->jabatan; ?>
                                                    </td>
                                                    <td>Nomor:
                                                        <?php echo $show->nomorSK; ?><br>Tanggal:
                                                        <?php echo date("d F Y",strtotime($show->tglSK)); ?>
                                                    </td>

                                                    <td>
                                                        Tingkat:
                                                        <?php echo $show->tingkat; ?><br>Lokasi:
                                                        <?php echo $show->nama_lokasi; ?>
                                                    </td>
                                                    <td><?php $file=$show->file_SK; ?>
                                                        <?php if(!empty($file)){ ?><a class='label label-danger' href='<?php echo base_url();?>assets/sk/<?php echo $file; ?>' target='_blank'>SK_Kepengurusan.pdf <i class='glyphicon glyphicon-download'></i></a><?php }else{ echo '';} ?>
                                                    </td>
                                        ...
                                        <div class='clearfix'>&nbsp;</div>
                                        <span class='label label-warning'>Jika ukuran file SK (PDF) lebih dari 512kb, maka tidak akan tersimpan.</span>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Organisasi Mahasiswa a.n. <strong>
                                <?php foreach ($s as $key) { echo $key->nama; }; ?>
                        </h3>
                    </div>
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/dashboard/tambah_kepengurusan'?>">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <input name="nomorSK" class="form-control" type="text" placeholder="Nomor SK..." required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <input name="tglSK" class="form-control" type="date" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <input name="fileSK" class="form-control" type="file" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <input name="nama_lokasi" class="form-control" type="text" placeholder="Lokasi..." required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8">
                                    <input name="tingkat" class="form-control" type="text" placeholder="Tingkat..." required>
                                </div>
                            </div>
        ...
        <div id="edit_<?php echo $id; ?>" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/dashboard/edit_kepengurusan'?>" enctype='multipart/form-data'>
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-3">Nomor SK</label>
                                <div class="col-xs-8">
                                    <input name="nomorSK" value="<?php echo $nomorSK;?>" class="form-control" type="text" placeholder="Nomor SK..." required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-3">Tanggal SK</label>
                                <div class="col-xs-8">
                                    <input name="tglSK" value="<?php echo $tglSK;?>" class="form-control" type="date" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-3">Jabatan</label>
                                <div class="col-xs-8">
                                    <input name="jabatan" class="form-control" value="<?php echo $jabatan;?>" type="text" placeholder="Jabatan..." required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-3">Nama Lokasi</label>
                                <div class="col-xs-8">
                                    <input name="nama_lokasi" class="form-control" value="<?php echo $nama_lokasi;?>" type="text" placeholder="Lokasi..." required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-3">Tingkat</label>
                                <div class="col-xs-8">
                                    <input name="tingkat" class="form-control" value="<?php echo $tingkat;?>" type="text" placeholder="Tingkat..." required>
                                </div>
                            </div>
        ...
        <div id="hapus_<?php echo $id; ?>" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/dashboard/hapus_kepengurusan'?>">
