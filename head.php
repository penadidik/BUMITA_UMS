...
<head>
    ...
    <meta charset="utf-8" />
    <title>ADMIN <?php foreach($halaman as $tampil){ echo $tampil->judul_halaman; } ?></title>
    ...
    <link rel="icon" href="<?php echo base_url();?>assets/images/laman/<?php foreach($halaman as $tampil){ echo $tampil->icon; } ?>" type="image/x-icon" />
